        ...
        public static void SetBlock(Type pType, Vector3i pPosition, UserSession pSession = null, Vector3i? pSourcePosition = null, Block pSourceBlock = null, byte[] pData = null)
        {
            ...
            if (constuctor != null)
            {
                ...
                if (pType.DerivesFrom<PlantBlock>())
                {
                    ...
                    {
                        ps = EcoSim.AllSpecies.OfType<PlantSpecies>().First(p => ps.BlockType == pType);
            ...
            if (constuctor != null)
            {
                ...
                //WorldObject newObject = WorldObjectUtil.Spawn(wObject.GetType().Name, wObject.Creator.Player.User, pPosition);
